...
class StructuresUI(MainUI):
    def __init__(self):
        ...
        self.all_predicates.addPredicate("structural analysis", "compute PCA - standard parameters", pca)

        findVolume = FindVolume(self.sentralControl)
        self.all_predicates.addPredicate("structural analysis", "volume - based on radius & height", findVolume)
